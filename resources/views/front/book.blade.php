...
<section class="text-gray-700 body-font overflow-hidden bg-white">
  <div class="container px-5 py-24 mx-auto">
    <div class="md:w-4/5 mx-auto flex flex-row">
      <div class="md:w-1/2 sm:w-full p-4">
        <img alt="Book caption" class="w-full rounded border border-gray-200" src="{{URL::asset('/img/book.png')}}">
      </div>
      <div class="w-1/2 sm:w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">Book Tittle</h2>
        ...
        <div class="flex" x-data="{ 'showModal': false }" @keydown.escape="showModal = false" x-cloak>
          <span class="title-font font-medium text-2xl text-gray-900">USD ${{ $book->price }}</span>
          <button @click="showModal = true" class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Buy</button> 
